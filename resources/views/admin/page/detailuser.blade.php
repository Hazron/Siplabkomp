            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="table-responsive mt-3">
                        <div class="btn-group">
                            <button type="button" class="btn btn-light bg-white dropdown-toggle"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Pilih Tabel
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" onclick="showTable('jadwal')">Jadwal
                                        Perkuliahan</a></li>
                                <li><a class="dropdown-item" href="#" onclick="showTable('riwayat')">Riwayat
                                        Peminjaman</a></li>
                            </ul>
                        </div>
