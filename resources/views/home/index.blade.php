            ...
            <div class="container-xxl py-5 bg-info hero-header mb-2">
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        ...
                        <!-- FOR SCHEDULE RUANG KOMPUTASI & ICT -->
            ...
            <div class="container px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Siplabkomp merupakan Sistem Informasi Peminjaman Ruang Komputasi, bertujuan memudahkan proses peminjaman ruang untuk perkuliahan hingga kegiatan himpunan.</p>
                    </div>
                    <div class="col-lg-5">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.8s" src="asset_homepage/img/illustration_comp.jpg">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row gy-5 gx-4 pt-5">
                    <div class="col-12">
                        ...
                        <p class="fw-bold text-white">Siplabkomp adalah website pelayanan mahasiswa guna untuk mempermudah peminjaman ruang untuk perkuliahan yang ada di fakultas sains dan teknologi</p>
                    </div>
